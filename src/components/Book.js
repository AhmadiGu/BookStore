...
const Book = ({ book }) => {
  const {
    item_id, category, title, author, progress = '0', currentChapter = 'Chapter 1',
  } = book;
    ...
    <div className="books">
      <div className="book-info">
        ...
        <div className="actions">
          ...
          <button type="button" className="btn remove" onClick={() => dispatch(removeBook(item_id))}> Remove</button>
          <div className="btn-divider" />
